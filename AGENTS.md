# English Pupil’s Book Standard Five — ADT Bundle Reference
...
**English Pupil’s Book Standard Five** — This is a Standard Five English pupil’s book from Tanzania, published by the Tanzania Institute of Education, and written in English for upper primary learners, roughly around Grade 5. It teaches core language skills such as vocabulary, comparison, directions, possession, verb tenses, conjunctions, active and passive voice, listening, speaking, message writing, and creative writing. The book uses a competency-based, activity-rich approach with dialogues, pictures, songs, poems, role-play, and real-life examples to build practical communication skills for everyday use.
...
├── ENGLISH-STD-5--2025-.db                    # SQLite database (pipeline state)
├── ENGLISH-STD-5--2025-.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Official Certificate of Approval from the United Republic of Tanzania, Ministry of Education, Science and Technology, for the English Pupil’s Book Standard Five.",
  "gl001": "above",
  "gl001_def": "at a higher level than something else"
}
```
...
```json
{
  "title": "English Pupil’s Book Standard Five",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en-GB"
...
| Original PDF | `ENGLISH-STD-5--2025-.pdf` |
| Pipeline database | `ENGLISH-STD-5--2025-.db` (SQLite) |
